					...
					<<?php echo esc_attr($title_tag); ?> class="site-title nova-site-title">
						<a href="<?php echo esc_url(home_url('/')); ?>" rel="home" class="nova-site-logo-link">
							<span class="nova-logo-text">
								<span
									class="nova-logo-n"><?php echo esc_html($first_letter); ?></span><?php echo esc_html($rest_name); ?>
							</span>
						</a>
				...
				<form class="header-search js-header-search<?php echo get_search_query() ? ' is-open' : ''; ?>"
					...
					<button type="button" class="header-search-submit header-search-toggle"
						...
						<svg class="header-search-icon header-search-icon-search" width="20" height="20"
							...
							<path d="M21 21l-4.35-4.35" stroke="currentColor" stroke-width="1.75"
								stroke-linecap="round" />
						</svg>
						<svg class="header-search-icon header-search-icon-close" width="20" height="20"
							viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
							focusable="false">
